...
class Encargado:
    ...
    def verificar_contraseña(self):
        consulta = "SELECT COUNT(*) FROM usuarios WHERE role = %s AND contraseña = %s"
    ...
    def sub_menu_alimentacion_ganado(self):
     while True:
        ...
        print("1. Consultar alimentacion registrada")
        print("2. Consultar Alimentación de Ganado")
        print("3. Vincular Alimentación a Ganado")
        print("4. Modificar Alimentación de Ganado")
    ...
    def menu_alertas_agua(self):
     while True:
        ...
        if opcion == "1":
            ...
            # Asignar id_usuario según el rol
            if self.role == 'ganadero':
                id_usuario = 1
            elif self.role == 'encargado':
                id_usuario = 2
            else:
    ...
    def menu_encargado(self):
        while True:
            ...
            if opcion == "1" and self.role == "encargado":
                self.menu_ganado()  
